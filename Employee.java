...

{
...

    {
        ...
        System.out.println(empName+"\t"+empNo+"\t"+gender+"\t"+expYrs
...

{
...

    {
        ...
        System.out.println("empName\tempNo\tgender\texpYrs\tbasicSalar\tbonus\tnetSalary\n");

        Rahul.getEmployeeDetails();

        Employee Rakesh = new Employee(); 

        Rakesh.setEmployee ("Rakesh",728198,"male",(byte) 25,20000.0d);
